...
define("_AM_SPROCKETS_REQUIREMENTS_INFO", "Ein Test ergab, dass leider nicht alle Systemvoraussetzungen erf�llt sind, um Sprockets reibungslos zu verwenden. Die untenstehenden Anweisungen sind nicht erf�llt.");
define("_AM_SPROCKETS_REQUIREMENTS_ICMS_BUILD", "Sprockets ben�tigt mindestens ImpressCMS 1.1.1 RC 1.");
define("_AM_SPROCKETS_REQUIREMENTS_SUPPORT", "Sollten sie irgendwelche Fragen oder Besognisse haben, besuchen sie bitte unser Forum: 
...
define("_AM_SPROCKETS_TAG_CREATE", "Hinzuf�gen eines Tags");
define("_AM_SPROCKETS_TAG", "Tag");
define("_AM_SPROCKETS_TAG_CREATE_INFO", "Bitte f�llen Sie das folgende Formular aus, um ein neues Tag zu erstellen.");
define("_AM_SPROCKETS_TAG_EDIT", "Tag bearbeiten");
define("_AM_SPROCKETS_TAG_EDIT_INFO", "Bitte f�llen Sie das folgende Formular aus, um dieses Tag zu bearbeiten.");
...
define("_AM_SPROCKETS_TAGLINK_CREATE", "Hinzuf�gen eines Taglinks");
define("_AM_SPROCKETS_TAGLINK", "Taglink");
define("_AM_SPROCKETS_TAGLINK_CREATE_INFO", "Bitte f�llen Sie das folgende Formular aus, um einen neuen Taglink zu erstellen.");
define("_AM_SPROCKETS_TAGLINK_EDIT", "Taglink bearbeiten");
define("_AM_SPROCKETS_TAGLINK_EDIT_INFO", "Bitte f�llen Sie das folgende Formular aus, um diesen Taglink zu bearbeiten.");
...
define("_AM_SPROCKETS_RIGHTS_CREATE", "Hinzuf�gen einer Lizenz (Berechtigung)");
define("_AM_SPROCKETS_RIGHTS_CREATE_INFO", "Bitte f�llen Sie das folgende Formular aus, um neue Berechtigungen zu erstellen.");
define("_AM_SPROCKETS_RIGHTS_EDIT", "Berechtugungen bearbeiten");
define("_AM_SPROCKETS_RIGHTS_EDIT_INFO", "Bitte f�llen Sie das folgende Formular aus, um die Berechtigung zu bearbeiten.");
...
define("_AM_SPROCKETS_ARCHIVE_CREATE", "Hinzuf�gen eines Archives");
define("_AM_SPROCKETS_ARCHIVE", "Archive");
define("_AM_SPROCKETS_ARCHIVE_CREATE_INFO", "Bitte f�llen Sie das folgende Formular aus, um ein neues Archiv zu erstellen.");
define("_AM_SPROCKETS_ARCHIVE_EDIT", "Archiv bearbeiten");
define("_AM_SPROCKETS_ARCHIVE_EDIT_INFO", "Bitte f�llen Sie das folgende Formular aus, um das Archiv zu bearbeiten.");
...
define("_AM_SPROCKETS_ARCHIVE_OFFLINE","<strong>Archiv Status: <span style=\"color:#red;\"> Offline.
    </span></strong> Sie sollten die Archivefunktionen in den Moduleeinstellungen �ndern, wenn Sie m�chten, dass Sprockets to serve metadata in response to incoming OAIPMH requests.");
...
define("_AM_SPROCKETS_CSS_SELECT_THEME", "W�hlen Sie ein Theme aus, um es zu bearbeiten");
define("_AM_SPROCKETS_CSS_AVAILABLE_STYLE_SHEETS", "Verf�gbare Style-Sheets");
...
// warnings
define("_AM_SPROCKETS_CATEGORY_DELETE_CAUTION", "Wollen Sie diese Kategorie wirklich l�schen? 
	Unterkategorien werden ebenfalls gel�scht (Dies betrifft jedoch nicht die Inhalte).");